<?php
    ...
    $stmt = $conexao->prepare("SELECT * FROM analista_dados WHERE email=? AND senha=?");
    ...
    if($resultado->num_rows > 0){
        ...
        session_start();
        $_SESSION['email_analista_dados'] = $tabela[0]['email'];
        $_SESSION['id_analista_dados'] = $tabela[0]['id'];
