...
$stmt = $conexao->prepare("INSERT INTO perguntas (texto_pergunta, tipo_campo, opcoes, equipe_alvo, ativa, gestor_id) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("ssssii", $texto_pergunta, $tipo_campo, $opcoes, $equipe_alvo, $ativa, $gestor_id);
